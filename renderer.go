...
func (r *Renderer) Line(line string, a ...interface{}) *Renderer {
	r.buf.WriteString(formatLine(line, a...))
	r.buf.WriteByte('\n')
	return r
}

// Rawl renders a line without format
func (r *Renderer) Rawl(line string) *Renderer {
